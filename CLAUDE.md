...
AI-powered word puzzle generator. Users describe a topic, Claude AI generates words/clues, app creates playable word search or crossword with lives, hints, timer, scoring, and difficulty scaling.
...
- Game state via `useReducer` action machines in `useWordSearchGame.ts` / `useCrosswordGame.ts`
